...
- Powracanie do tego samego rozróżnienia w kilku podobnych akapitach: jeśli dana relacja logiczna organizuje fragment, zostaw ją jako oś argumentu i rozwijaj kolejne konsekwencje, zamiast wielokrotnie parafrazować tę samą myśl.
